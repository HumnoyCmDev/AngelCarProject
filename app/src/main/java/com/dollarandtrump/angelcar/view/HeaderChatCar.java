...
public class HeaderChatCar extends BaseCustomViewGroup {
    ...
    public HeaderChatCar(Context context) {
        super(context);
        initInflate();
        initInstances();
    }

    public HeaderChatCar(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public HeaderChatCar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public HeaderChatCar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.custom_view_chat_header, this);
    }

    private void initInstances() {
        banner = (ImageBanner) findViewById(R.id.custom_view_imageBanner);
        title = (TextView) findViewById(R.id.custom_view_chat_header_tvTitle);
//        detail = (TextView) findViewById(R.id.custom_view_chat_header_tvDetails);
        brand = (TextView) findViewById(R.id.custom_view_chat_header_tvBrand);
        profile = (TextView) findViewById(R.id.custom_view_chat_header_tvName);
        ic_Profile = (ImageView) findViewById(R.id.custom_view_header_chat_ic);
        btnFollow = (ToggleButton) findViewById(R.id.custom_view_header_chat_follow);
        time = (TextView) findViewById(R.id.custom_view_header_chat_time);
    }
