...
public class RxSendMessage implements Observable.OnSubscribe<String> {
    ...
    public RxSendMessage(SendMessageType type,Uri uri,
    ...
    public RxSendMessage(SendMessageType type,String id,String messageFromUser,String message,String messageBy,String user) {
        this.type = type;
        mId = id;
        mMessage = message;
        mMessageFromUser = messageFromUser;
